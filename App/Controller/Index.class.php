...
class Index extends controller
{
    ...
    * */
    ...
    function Ctl()
    {
        ...
        $demo = new Demo();
        $daemonDriver -> AddTask(['function' => [$demo, 'Demo'], 'argv' => [100], 'concurrency' => 4 , 'lifecycle' => 30, 'proName' => 'demo -> demo_1']);
        $daemonDriver -> AddTask(['function' => [$demo, 'Demo'], 'argv' => [90],  'concurrency' => 4 , 'lifecycle' => 30, 'proName' => 'demo -> demo_2']);
