...
class Image
{
    ...
    function Index()
    {
        ...
        $first->WriteText("算命", 70, 80, $font, 45, [
            0,
            0,
            0,
            1,
        ]);
        $first->WriteText("姻缘/财运/生子/吉凶", 15, 120, $font, 20, [
            0,
            0,
            0,
            1,
        ...
        $second->WriteText("于彬", 60, 80, $font, 45, [
            0,
            0,
            0,
            1,
        ]);
        $second->WriteText("你的姻缘将至，", 10, 109, $font, 20, [
            0,
            0,
            0,
            1,
        ]);
        $second->WriteText("给500大洋揭秘姻缘！", 10, 133, $font, 20, [
            0,
            0,
            0,
            1,
        ]);
        $second->WriteText("收款账号见二维码", 60, 175, $font, 16, [
            0,
            0,
            0,
            1,
        ...
        $last->WriteText("纯属玩笑，", 30, 90, $font, 30, [
            0,
            0,
            0,
            1,
        ]);
        $last->WriteText("哈哈哈哈！", 30, 120, $font, 30, [
            0,
            0,
            0,
            1,
